...
<div class="sb-brand">
  ...
  <div class="sb-brand__name">SB<b>erp</b></div>
</div>
...
<nav class="sb-nav" id="sbNav">
  ...
  <a class="sb-nav__item" data-page="permissions" data-tip="권한 관리" href="permissions.html">
    <i class="bi bi-shield-lock"></i><span class="sb-nav__label">권한 관리</span>
  </a>

  <div class="sb-nav__section">업무</div>
  <a class="sb-nav__item" data-page="documents" data-tip="전자결재" href="documents.html">
  ...
  <a class="sb-nav__item" data-page="resources" data-tip="자원예약" href="resources.html">
    <i class="bi bi-calendar2-check"></i><span class="sb-nav__label">자원 · 예약관리</span>
  </a>
</nav>
