  ...
  <div class="sb-card">
    <div class="sb-card__head">
      ...
      <div class="right">
        ...
        <a href="${pageContext.request.contextPath}/resv/list?status=WAI" class="btn btn-ghost btn-sm">대기</a>
        <a href="${pageContext.request.contextPath}/resv/list?status=APP" class="btn btn-ghost btn-sm">승인</a>
        <a href="${pageContext.request.contextPath}/resv/list?status=REJ" class="btn btn-ghost btn-sm">반려</a>
      </div>
    </div>
