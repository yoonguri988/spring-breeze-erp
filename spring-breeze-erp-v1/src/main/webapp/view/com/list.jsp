...
<!-- 페이지 헤더 -->
	<div class="d-flex align-items-center justify-content-between mb-3">
		...
		<a class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/com/add">
			회사 등록
		</a>
	</div>
	<!-- 검색 카드 박스 -->
    <div class="card mb-3 shadow-sm">
        <div class="card-body py-3">
            <form method="GET"
                  action="${pageContext.request.contextPath}/com/list"
                  id="searchForm">
                    ...
                    <div class="input-group flex-grow-1">
                        ...
                        <c:if test="${not empty param.keyword}">
                            <a class="btn btn-outline-secondary"
                               href="${pageContext.request.contextPath}/com/list">
                                초기화
                            </a>
                        </c:if>
                    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a class="btn btn-outline-danger btn-sm"
                                   href="${pageContext.request.contextPath}/com/delete?comId=${com.comId}&page=${currentPage}&keyword=${param.keyword}"
