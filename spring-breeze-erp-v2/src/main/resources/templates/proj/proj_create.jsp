...
<div class="sb-page-head">
  <div class="sb-page-head__txt">
    <div class="sb-breadcrumb"><a href="${pageContext.request.contextPath}/index.jsp">홈</a> <i class="bi bi-chevron-right"></i> 업무 <i class="bi bi-chevron-right"></i> 프로젝트 <i class="bi bi-chevron-right"></i> 생성</div>
    <h1>프로젝트 생성</h1>
...
<div class="sb-card">
  <div class="sb-card__body">
    <form action="${pageContext.request.contextPath}/proj/proj_create" method="post" onsubmit="return check()">
      ...
      <div class="mb-3">
        ...
        <textarea id="pro_desc" name="proDesc" class="form-control" rows="4" placeholder="프로젝트에 대한 설명을 입력하세요"></textarea>
      </div>
      ...
      <div class="mb-4">
        ...
        <input type="text" id="reg_date" class="form-control" value="<%= today %>" readonly style="max-width:200px;background:#fafbfc;" />
      </div>
