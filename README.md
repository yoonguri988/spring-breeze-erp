...
|:---:|:---:|:---:|---|:---:|
| **v1** | 2025.06.11 ~ 06.26 | 6인 | JSP · MySQL 기반 신규 구축, <br/>8개 모듈(로그인 · 권한 / 회사 · 부서 / 사원 / 전자결재 / 프로젝트 · 태스크 / <br/>자원 · 예약 / 공지) | [README](./spring-breeze-erp-v1/README.md) |
...
|---|:---:|---|---|---|
| **최윤정** | 팀장 | 회사 · 부서 · 인증 · 권한 | 회사 · 부서 · 자원 예약 | 회사 · 부서 · 인증 · 자원 예약 · **급여** |
| **정수정** | 팀원 | 사원 관리 | 인사 · 평가 · 권한 | 사원 · 인사평가 · 권한 · 직급 · **근태 · 연차 · 관리자 대시보드** |
| **김주엽** | 팀원 | 전자결재 양식 | 전자결재 | 전자결재 · **휴가 신청 · 사원 대시보드** |
| **최다영** | 팀원 | 프로젝트 · 태스크 | 프로젝트 · 태스크 · 공지 | 프로젝트 · 태스크 · 공지 · **채용 · 지원자 · 지원자 대시보드** |
...
최종 버전(v3) 기준, 팀원 4명이 각자 맡은 도메인에서 겪은 대표 사례입니다. 전체 사례(v1 · v2 포함)는 버전별 README 7장을 참고해주세요.
 
| 담당자 | 사례 | 요약 |
|:---:|---|---|
| **최&nbsp;윤&nbsp;정** | 급여&nbsp;계산&nbsp;순서&nbsp;의존성 | Spring `List` 주입 순서에 기대지 않도록, <br/>의존 계산기가 선행 계산기를 DI로 직접 주입받아 호출하는 구조로 변경 |
| **정&nbsp;수&nbsp;정** | RAG&nbsp;유사도&nbsp;필터 | 절대 임계값 대신 "1위 점수 대비 상대적 격차" 기준으로 재설계해, <br/>정답 근거 조항이 데이터 분포에 따라 부당하게 탈락하는 문제를 해결 |
| **김&nbsp;주&nbsp;엽** | 연차&nbsp;양식&nbsp;필수&nbsp;필드 | 검증 시점을 승인 후 파싱 시점에서 양식 등록 시점으로 앞당기고, <br/>LEAVE 카테고리 양식은 필수 필드 3개가 모두 있어야 등록되도록 차단해 결재-연차 불일치를 제거 |
| **최&nbsp;다&nbsp;영** | 채용&nbsp;프로세스&nbsp;관리 | 지원자 상태 · 단계를 화면 곳곳에서 따로 확인해야 하던 문제를, <br/>채용 단계별 칸반 보드 + 드래그 앤 드롭 UI로 시각화해 해결 |
